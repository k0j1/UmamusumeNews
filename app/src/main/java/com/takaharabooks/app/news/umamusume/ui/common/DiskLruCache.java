package com.takaharabooks.app.news.umamusume.ui.common;
...
import com.takaharabooks.app.news.umamusume.BuildConfig;
...
public abstract class DiskLruCache {
    ...
    private static final int IO_BUFFER_SIZE = 10 * 1024; // 10KB
    ...
    private final int maxCacheItemSize = 1000; // 64 item default
    private long maxCacheByteSize = 1024 * 1024 * 10; // 5MB default
     ...
     * {@link DiskLruCache#(, int)} first to set
