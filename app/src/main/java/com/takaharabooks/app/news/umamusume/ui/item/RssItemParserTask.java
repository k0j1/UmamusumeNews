package com.takaharabooks.app.news.umamusume.ui.item;
...
import com.takaharabooks.app.news.umamusume.MainActivity;
import com.takaharabooks.app.news.umamusume.ui.home.HomeFragment;
                ...
                switch (eventType) {
                    case XmlPullParser.START_TAG:
                        ...
                        else if (currentItem != null)
                        {
                            ...
                            // 日付
                            else if (tag.equals("issued") || tag.equals("date") || tag.equals("pubDate"))
                            {
                            ...
                            // カテゴリ
                            else if(tag.equals("subject")/* || tag.equals("category")*/)
                            {
                                String strCategory = currentItem.getCategory().toString();
                                strCategory += "," + parser.nextText();
                                currentItem.setCategory(strCategory);
                            }
                            // 画像のURL
                            else if(tag.equals("enclosure")/* || tag.equals("img")*/)
                            {
                                String strLink = "";
                                for(int i=0; i<parser.getAttributeCount(); i++)
                                {
